...
class App extends React.Component {
  ...
  addEntry (entryState) {
    ...
    fetch("https://rccgoodsamaritan.atwebpages.com/insertService.php", {
      method: "POST", 
      body: formData
    })
    .then(response => {
    ...
    .then(data => {
      ...
      return fetch("https://rccgoodsamaritan.atwebpages.com/getServices.php");
    })
  ...
  fetchNumFoodBags() {
    return fetch("https://rccgoodsamaritan.atwebpages.com/getFoodBags.php")
      .then(response => {
        if(!response.ok) {
          throw new Error("Network response was not ok");
        }
...
class LoginPage extends React.Component {
  ...
  verifyLogin() {
    ...
    fetch("https://rccgoodsamaritan.atwebpages.com/apiProxy.php?endpoint=verifyUser.php", {
      method: "POST",
      headers: {"Content-Type": "application/json"},
